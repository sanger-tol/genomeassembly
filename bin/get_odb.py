...
def get_odb(asm, file_out):
    ...
    response = requests.get("https://goat.genomehubs.org/api/v2/search?result=taxon&taxonomy=ncbi&includeEstimates=false&offset=0&summaryValues=count&query=tax_name%28icAdaBipu%29&fields=busco_lineage").json()["results"]
